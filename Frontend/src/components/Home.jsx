...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-purple-100 to-purple-700">
//       <div className="container mx-auto px-4 py-6 flex justify-between items-center">
//         <h1 className="text-3xl font-bold text-purple-900">BookNook</h1>
//       </div>
...
//           </h2>
//           <p className="text-xl text-purple-800 font-serif mb-10 max-w-2xl mx-auto">
//             BookNook uses AI-powered recommendations to connect you with books
//             you'll love. Start your personalized reading journey today!
//           </p>
//           <Link
//             to="/userProfile"
...
//           >
//             Build Your Personal Reading Profile
//           </Link>
//         </section>
//         <section
//           id="features"
...
//           </h2>
//           <p className="text-xl text-purple-700 mb-10 max-w-2xl mx-auto">
...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-purple-700">
      ...
      <main className="container mx-auto px-4 py-12">
        <section className="text-center mb-20">
          <h2 className="text-3xl sm:text-5xl font-bold text-purple-900 mb-6">
            Discover Your Next Great Read
          </h2>
          <p className="text-lg sm:text-xl text-purple-800 font-serif mb-10 max-w-2xl mx-auto">
            BookNook uses AI-powered recommendations to connect you with books
            you'll love. Start your personalized reading journey today!
          </p>
          <Link
