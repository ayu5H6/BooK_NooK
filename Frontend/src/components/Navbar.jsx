...
//               <button
//                 onClick={() => setIsGenreDropdownOpen(!isGenreDropdownOpen)}
//                 className="text-white hover:text-purple-300  px-3 py-2 rounded-md text-base font-medium transition
// duration-300 w-full text-left flex justify-between items-center"
//               >
...
//       <div className="bg-gradient-to-r from-purple-900 to-blue-900 text-white py-2 text-center shadow-md">
