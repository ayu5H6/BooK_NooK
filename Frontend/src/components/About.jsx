...
const About = () => {
  ...
  const books = [
    ...
    {
      text: "Share Your Story and Build Your Legacy",
      color: "bg-gradient-to-r from-purple-800 to-purple-500",
    },
    {
      text: "Dive Into Endless Genres with Precision Picks",
      color: "bg-gradient-to-r from-yellow-800 to-yellow-500",
    },
  ];
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <p className="text-xl mb-8 leading-relaxed max-w-2xl mx-auto text-center font-serif">
          Track your reading goals, enjoy personalized recommendations, and
          share your stories in a vibrant community of book lovers. Dive into
          endless genres and elevate your reading journey today!
        </p>
        {/* Interactive Buttons */}
